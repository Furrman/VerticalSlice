...
namespace TravelInspiration.API.Shared.Persistance.Migrations
{
    ...
    [Migration("20240810220444_SuggestedFieldaddedToStop")]
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Itinerary", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2047),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2050),
            ...
            modelBuilder.Entity("TravelInspiration.API.Shared.Domain.Entities.Stop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2316),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2328),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2337),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2345),
                        ...
                        new
                        {
                            Id = 5,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2353),
                        ...
                        new
                        {
                            Id = 6,
                            CreatedBy = "DATASEED",
                            CreatedOn = new DateTime(2024, 8, 10, 22, 4, 44, 333, DateTimeKind.Utc).AddTicks(2361),
